...
class MedicationPeriodPatientTable extends React.Component {

 
 
openMedicationPeriodPage(props)
{
    this.state.redirectTo = "/medicationPeriodPatientPage/"+props.original.id;
...
export default MedicationPeriodPatientTable;