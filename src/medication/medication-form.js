...
class MedicationForm extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            formControls: {
                ...
                sideEffects: {
                    value: '',
                    placeholder: 'What is the medication\'s Side effects?',
                    valid: false,
                    touched: false,
                    validationRules: {
                        minLength: 3,
   ...
   toggleForm() {
    ...
    registerMedication(medication) {
        return DOCTOR_API.postMedication(medication, (result, status, error) => {
        ...
        return (
            <div>
                ...
                <FormGroup id='dosage'>
                    ...
                    <div className={"error-message"}> * Dosage must have at least 3 characters</div>}
                </FormGroup>
